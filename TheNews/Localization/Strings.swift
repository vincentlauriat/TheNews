...
enum Strings {
    static let table: [String: [String: String]] = [
        "fr": [
            ...
            "unfavorite": "Retirer",
            "share": "Partager",
            "save_image_confirm_title": "Enregistrer l'image dans Photos ?",
            "save_image_action": "Enregistrer",
            "save_image_failure": "Impossible d'enregistrer l'image.",
            "save_image_permission_denied": "Accès à Photos refusé. Autorise-le dans Réglages > TheNews.",
            ...
            "topic_keywords_footer": "Valide chaque mot-clé avec Retour ou une virgule. Insensible aux accents et à la casse.",
            "topic_keyword_placeholder": "Ajouter un mot-clé…",
            "topic_keyword_duplicate": "Ce mot-clé est déjà dans la liste.",
            "topic_keyword_empty": "Le mot-clé ne peut pas être vide.",
            "topic_keyword_remove": "Supprimer le mot-clé",
            "topic_delete": "Supprimer le sujet",
            "topic_enabled": "Sujet actif",
            "topic_notify": "Me notifier",
            "topic_notify_footer": "Envoyer une notification pour les nouveaux articles correspondants.",
            "alerts_no_matches_title": "Aucune correspondance",
            "alerts_no_matches_desc": "Aucun article ne correspond pour l'instant à tes sujets de veille.",
            "cancel": "Annuler",
            "save": "Enregistrer",
        ...
        "en": [
            ...
            "share": "Share",
            "save_image_confirm_title": "Save image to Photos?",
            "save_image_action": "Save",
            "save_image_failure": "Couldn't save the image.",
            "save_image_permission_denied": "Photos access denied. Allow it in Settings > TheNews.",
            ...
            "topic_keywords_footer": "Confirm each keyword with Return or a comma. Case- and accent-insensitive.",
            "topic_keyword_placeholder": "Add a keyword…",
            "topic_keyword_duplicate": "This keyword is already in the list.",
            "topic_keyword_empty": "The keyword can't be empty.",
            "topic_keyword_remove": "Remove keyword",
            "topic_delete": "Delete topic",
            "topic_enabled": "Topic active",
            "topic_notify": "Notify me",
            "topic_notify_footer": "Send a notification for matching new articles.",
            "alerts_no_matches_title": "No matches",
            "alerts_no_matches_desc": "No articles match your watch topics yet.",
            "cancel": "Cancel",
            "save": "Save",
