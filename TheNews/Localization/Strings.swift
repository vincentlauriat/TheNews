...
enum Strings {
    static let table: [String: [String: String]] = [
        "fr": [
            ...
            "digest_section": "Synthèse IA",
            "digest_section_footer": "Réglages de la synthèse générée à la demande depuis une liste d'articles (sur l'appareil).",
            "digest_length": "Longueur",
            "digest_concise": "Concise",
            "digest_detailed": "Détaillée",
            "digest_format": "Format",
            "digest_bullets": "Puces",
            "digest_paragraph": "Paragraphe",
            "display_mode_list": "Liste",
            "display_mode_card": "Cartes",
            "display_mode_section": "Affichage des articles",
            "digest_tone": "Ton",
            "digest_tone_neutral": "Neutre",
            "digest_tone_explanatory": "Explicatif",
            "digest_tone_wire": "Dépêche",
            "digest_count": "Articles pris en compte",
            ...
            "smart_alerts_section": "Alertes intelligentes",
            "smart_alerts": "Correspondance intelligente",
            "smart_alerts_footer": "Complète la recherche par mots-clés avec Apple Intelligence, pour capter aussi les reformulations et synonymes (ex. « réchauffement climatique » pour le sujet « écologie »). Nécessite un appareil compatible ; désactivée sinon.",
            "ai_summary_badge": "Résumé généré par IA",
        ...
        "en": [
            ...
            "digest_section": "AI digest",
            "digest_section_footer": "Settings for the on-demand summary generated from a list of articles (on-device).",
            "digest_length": "Length",
            "digest_concise": "Concise",
            "digest_detailed": "Detailed",
            "digest_format": "Format",
            "digest_bullets": "Bullets",
            "digest_paragraph": "Paragraph",
            "display_mode_list": "List",
            "display_mode_card": "Cards",
            "display_mode_section": "Article display",
            "digest_tone": "Tone",
            "digest_tone_neutral": "Neutral",
            "digest_tone_explanatory": "Explanatory",
            "digest_tone_wire": "Wire",
            "digest_count": "Articles considered",
            "favorite": "Favorite",
            "unfavorite": "Remove",
            ...
            "smart_alerts_section": "Smart alerts",
            "smart_alerts": "Smart matching",
            "smart_alerts_footer": "Complements keyword search with Apple Intelligence, to also catch rewordings and synonyms (e.g. “global warming” for the “ecology” topic). Requires a compatible device; disabled otherwise.",
            "ai_summary_badge": "AI-generated summary",
